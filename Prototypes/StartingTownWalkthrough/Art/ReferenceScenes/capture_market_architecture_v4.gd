...
const BASE := "res://validation/market_architecture_v4"
const CANDIDATE := "res://assets/reference_scenes/market_architecture_v4_manifest.json"
...
func capture() -> void:
    ...
    print("LEVEL0_MARKET_V4_CAPTURE "+JSON.stringify({"revision":revision,"technical_passed":report.technical_passed,"gate_walk_distance_m":report.get("gate_walk_distance_m",0),"features":report.projected_features.size(),"visual_approval":false}))
