...
- Boss总生命值为1440。一阶段顶部测绘器约每4.2秒完成一次“锁定线—长激光”攻击；二阶段彻底取消长激光，改为约每0.42秒发射一枚两端发光、没有箭头的短激光段。短激光只在生成时瞄准玩家，飞行途中不追踪，玩家可以利用移动、跳跃与平台空隙躲避弹幕。前方锯齿在普通巡逻时没有接触伤害；一阶段每10秒、二阶段每5.6秒进入喷气预警，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
...
- `S / Ctrl` 下蹲可降低碰撞高度躲过地面锯齿；站在Boss房三级单向平台上时按下蹲会穿过当前平台
