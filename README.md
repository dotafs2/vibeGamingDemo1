...
- Boss总生命值为1440。一阶段顶部测绘器约每4.2秒完成一次“锁定线—长激光”攻击；二阶段彻底取消长激光，改为约每0.42秒发射一枚两端发光、没有箭头的短激光段。短激光只在生成时瞄准玩家，飞行途中不追踪，玩家可以利用移动、跳跃与平台空隙躲避弹幕。前方锯齿在普通巡逻时没有接触伤害；一阶段每10秒、二阶段每5.6秒进入喷气预警，喷气结束当帧立即进入高速冲刺，不再追加等待，只有冲刺阶段会造成伤害
...
- 液压锤每次点击只执行一次双臂带动的头顶劈落：锤头沿肩上至身体前下方的圆弧运动，躯干轻微随动，完成后立即收回，不用整体旋转角色或单独转动锤子冒充挥击
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。一阶段观察约每4.2秒一次的长激光锁定线；半血后二阶段改为约5.6秒短激光弹幕窗口，随后清场并进入喷气冲刺，玩家还要在冲刺结束后立刻躲开约0.8秒快速跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有长激光、短激光段、冲刺锯齿和落地钻头会造成伤害。
