...
- Boss总生命值为720。前方锯齿在普通巡逻时没有接触伤害；每10秒Boss停步喷气1.25秒，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
- Boss降至半血后，每次锯齿冲刺结束必定接一次跳钻：1.1秒上升、1秒在玩家头顶追踪、0.9秒锁定下落，正好3秒落地；起跳期间核心无敌，腹部大型钻头只在下落时伸出
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。玩家利用下蹲、穿过三级单向平台和跳跃躲避每10秒一次的锯齿冲刺；半血后还要在冲刺结束后躲开3秒跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有攻击阶段会受伤。
