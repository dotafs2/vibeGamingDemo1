...
- Boss总生命值为720。一阶段顶部测绘器约每3秒显示一次锁定线并发射激光；二阶段改为0.12秒预警、0.12秒生效、约0.58秒间隔的高频脉冲射击，单发伤害相应降低。前方锯齿在普通巡逻时没有接触伤害，每10秒Boss停步喷气1.25秒，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。玩家先观察测绘激光的锁定线，再利用下蹲、穿过三级单向平台和跳跃躲避每10秒一次的锯齿冲刺；半血后还要在冲刺结束后立刻躲开1秒跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有激光、冲刺锯齿和落地钻头会造成伤害。
