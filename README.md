...
- 当前战斗只验证长剑挥砍、生命、受伤、Boss追击、冲撞和弹体，暂不视为正式平衡
...
- 一把不会消耗的测试长剑；剑柄挂接在右手末端，攻击时右臂带动剑从右上向右下挥砍
...
- 与转运站约等宽的一屏Boss房间；掘脉者会封锁入口、追击冲撞并发射弹体，被击败后可以安全回收时相核心
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并执行敌对指令，封锁入口，开始追击、冲撞和发射弹体。
