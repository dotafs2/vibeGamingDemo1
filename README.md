...
- 三个跨时代位置一致的背景地标：左侧加工厂、中央维修站、右侧闸门机房
- 2047年的完整厂房、通电管线和工作灯，以及2147年同位置的断裂支柱、下垂管线、熄灭灯具和瓦砾
...
8. 配重拉起大门，安全卡扣将其锁定，玩家穿过现代矿道并抵达时间出口。
...
- 两个时代必须保留相同的厂房外轮廓、支柱坐标、管线路径、灯位和闸门机房；现代只表现这些物体的老化、断裂与废弃结果
- 玩家能够通过改变历史打开新的场景路径
- 玩家第一眼能理解“过去的行为改变了现代”
