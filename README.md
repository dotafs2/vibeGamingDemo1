...
- 育苗箱、湿润土床、百年树木和同一堵墙负责验证完整的可见因果链
...
1. 玩家出生在现代，看到一堵无法通过的完整墙体。
2. 玩家按 `Q` 无缝进入温暖、完整的过去矿镇。
3. 玩家推动带幼苗的种植箱，将它放入墙边的湿润土床，幼苗当场扎根。
4. 玩家按 `Q` 回到冰冷、破败的现代。
5. 同一位置的幼苗连续长成百年大树，根系逐渐顶开同一堵墙。
6. 玩家穿过原本封闭的区域并抵达时间出口。
...
- 过去把育苗箱种入湿土后，切换过程中能看到幼苗连续长成大树
- 现代墙体具有被树根逐步顶开的过程，而不是按 Q 后无原因坍塌
- 玩家能够通过改变历史打开新的场景路径
- 玩家第一眼能理解“过去的行为改变了现代”
