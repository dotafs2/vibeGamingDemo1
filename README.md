...
- 实验室因果节点：玩家启动最终时相扫描，使工作人员按安全流程撤入隔离室，再从开启的防爆门进入内侧安装四枚时锁式定向破门栓
...
12. 玩家在2147年发现Boss防爆门已经锈死成墙，外部记录明确写着“外侧爆破会损坏时相核心，只能使用门内紧急破门槽”。
13. 玩家回到2047年，与最终维护区的工程师交谈，得知正在维护的是03型时晶采掘机“掘脉者”，它的核心正是时间机器需要的稳定能源。
14. 玩家在工程师确认后启动最终时相扫描；工作人员按照安全流程撤入隔离观察室，监控受扫描干扰，防爆门进入维护开启状态。
15. 玩家穿过防爆门但不能越过内部时相安全线，在门内侧按 `E` 将四枚时锁式定向破门栓装入标准紧急槽，再回到实验室一侧。
16. 玩家切回2147年，在墙左侧接收器按 `E` 发送时间锚信号；四枚破门栓只向Boss房内部切断门框，门体向内倒下。
17. 玩家越过倒塌门体后，掘脉者识别到时间锚并执行敌对指令，封锁入口，开始追击、冲撞和发射弹体。
18. 需要返回时，玩家先在2147年穿过坍塌入口回到井底，再切到2047年，靠近完整轿厢按 `E` 上升。
