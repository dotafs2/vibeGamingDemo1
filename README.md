...
- Boss总生命值为720。顶部测绘器会先显示锁定线再发射激光；前方锯齿在普通巡逻时没有接触伤害，每10秒Boss停步喷气1.25秒，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
- Boss降至半血后，每次锯齿冲刺结束必定接一次1秒跳钻：0.35秒上升、0.2秒追踪、0.45秒锁定下落；起跳期间核心无敌，腹部大型金属钻头从舱口直接伸出，不显示多余的黑色伸缩杆
