...
- Boss总生命值为1440。一阶段顶部测绘器约每3.8秒完成一次“锁定线—长激光”攻击，只提高释放频率，不改变锁定时间、激光持续时间或贯穿速度；二阶段彻底取消长激光，改为约每0.42秒发射一枚两端发光、没有箭头的短激光段。前方锯齿在普通巡逻时没有接触伤害；一阶段每10秒、二阶段每5.6秒进入喷气预警，喷气结束当帧立即进入高速冲刺，且二阶段冲刺速度由19提高到23，只有冲刺阶段会造成伤害
...
- 回弹扳手不会在按键瞬间凭空生成投射物：先在手中完成约0.17秒的投掷摆臂，经过身体前方时脱手，之后手臂继续随动，扳手独立旋转飞行并自动返回
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。一阶段观察约每3.8秒一次的长激光锁定线；半血后二阶段改为约5.6秒短激光弹幕窗口，随后清场并进入更高速的喷气冲刺，玩家还要在冲刺结束后立刻躲开约0.8秒快速跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有长激光、短激光段、冲刺锯齿和落地钻头会造成伤害。
