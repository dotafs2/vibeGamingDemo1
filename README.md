...
- 一套由未来NPC预先交给主角的四枚时锁式定向破门栓；初始位于背包第4格，装入2047年的门内紧急槽后立即从背包消失
- 一把不会消耗弹药的时相校准器；它原本用于远程调试采掘机核心，主角用它发射检修脉冲并强制Boss停机
...
- 时间观察环右侧在两个时代都是同一张档案桌：2047年放着不能擅自翻阅的原始工单，2147年的残存终端则保存着工单 `M-03-7721`，玩家可以从现代档案中记住编号和工作范围
- 2047年是03型时晶采掘机“掘脉者”封存前的最后维护日；维修工程师会介绍它的采矿用途、时相核心与内侧紧急破门结构
- 工单只授权玩家维护防爆门本体和门内维修凹槽，不授权进入Boss维护区；黄色安全线构成明确边界，强行越界会被工程师警告并拦下
- 实验室因果节点：玩家启动最终时相扫描，使工作人员按安全流程撤入隔离室，再从开启的防爆门进入门内维修凹槽安装四枚时锁式定向破门栓；安装后必须返回控制台结束扫描，由工程师验收并重新封门
- 2147年Boss门已经断电锈死成墙；玩家从外部发送时间锚信号，使内侧破门栓切断门框，厚重门体向Boss房内部倒下
- 扩建后的纵向Boss试验场：左右各有三级维护平台，玩家可以像走阶梯一样逐层跳跃；底层中央留给大型采掘机构
- 掘脉者由宽履带底盘、旋转掘进轮、矿石输送带与料斗、外露时晶核心和测绘射线器组成，外观和功能共同解释“03型时晶采掘机”的名称
- Boss机体碰撞只会阻挡并推开玩家，不造成伤害；唯一伤害来源是先显示瞄准线、再正式发射的时晶扫描射线
...
12. 玩家在2147年发现Boss防爆门已经锈死成墙，外部记录明确写着“外侧爆破会损坏时相核心，只能使用门内紧急破门槽”；随后在时间观察环右侧的残存档案终端找到防爆门封存工单 `M-03-7721`。
13. 玩家回到2047年，向最终维护区工程师报出工单号。工程师确认主角是来维护防爆门的外包人员，只开放门体与内侧维修凹槽，不允许进入掘脉者维护区；交谈中同时介绍Boss的采矿用途和时相核心。
14. 玩家在工程师确认后启动最终时相扫描；工作人员按照安全流程撤入隔离观察室，监控受扫描干扰，防爆门进入维护开启状态。
15. 玩家进入门内维修凹槽，按 `E` 将四枚时锁式定向破门栓装入标准紧急槽。破门栓的外壳和回传信号会模拟2047年的标准门框诊断塞；凹槽之后设有黄色安全线，若玩家试图继续进入Boss区域，工程师会立即警告并强制其退回维修侧。
16. 玩家返回控制台结束扫描。工程师回到岗位时只能读到四个合格诊断塞，因此正常完成工单验收并重新封存防爆门；主角在不进入Boss房且不暴露破门栓的情况下，把装置留在了门框内侧。
17. 玩家切回2147年，在墙左侧接收器按 `E` 发送时间锚信号；四枚破门栓只向Boss房内部切断门框，门体向内倒下。
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并执行敌对指令，封锁入口并启动测绘射线。玩家沿左右三级维护平台跳跃，利用预警线躲开真正会造成伤害的射线，再用时相校准器射击中央外露核心；接触大型机体只会被推开，不会扣血。
