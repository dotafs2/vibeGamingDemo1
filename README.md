...
- Boss总生命值为1440。一阶段顶部测绘器每5秒完成一次“锁定线—长激光”攻击；二阶段彻底取消长激光，改为约每0.42秒发射一枚两端发光、没有箭头的短激光段。短激光只在生成时瞄准玩家，飞行途中不追踪，玩家可以利用移动、跳跃与平台空隙躲避弹幕。前方锯齿在普通巡逻时没有接触伤害，每10秒Boss停步喷气1.25秒，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。一阶段观察每5秒一次的长激光锁定线；半血后二阶段改为持续穿过短激光弹幕，并在每次冲刺后立刻躲开约0.8秒快速跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有长激光、短激光段、冲刺锯齿和落地钻头会造成伤害。
