...
- 四种不消耗弹药的试验武器：可自由瞄准的时相枪、按住连续攻击的双手脉冲钻、点击一次便从头顶向前劈下并立即收回的液压锤，以及投出后自动返回的开口扳手
...
- Boss总生命值为720。一阶段顶部测绘器每5秒完成一次“锁定线—长激光”攻击；二阶段彻底取消长激光，改为约每0.42秒发射一枚长度约1.35格的短时晶光弹。光弹只在生成时瞄准玩家，飞行途中不追踪，玩家可以利用移动、跳跃与平台空隙躲避弹幕。前方锯齿在普通巡逻时没有接触伤害，每10秒Boss停步喷气1.25秒，再让锯齿朝玩家高速冲刺，只有冲刺阶段会造成伤害
- Boss降至半血后，每次锯齿冲刺结束必定接一次1秒跳钻：0.35秒上升、0.2秒追踪、0.45秒锁定下落；起跳期间核心无敌，腹部加宽的大型金属钻头从舱口直接伸出，不显示多余的黑色伸缩杆
...
18. 玩家越过倒塌门体后，掘脉者识别到时间锚并解除封存。一阶段观察每5秒一次的长激光锁定线；半血后二阶段改为持续穿过短光弹幕，并在每次冲刺后立刻躲开1秒跳钻。主角仍可直接穿过普通巡逻中的机体和锯齿，只有长激光、短光弹、冲刺锯齿和落地钻头会造成伤害。
