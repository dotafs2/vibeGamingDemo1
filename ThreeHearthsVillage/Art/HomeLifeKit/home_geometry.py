"""Shared-style local geometry primitives, vendored from our VillageKit source.

Self-contained: HomeLifeKit generation never modifies or executes the older kits.
"""
import math
import bpy
import bmesh
