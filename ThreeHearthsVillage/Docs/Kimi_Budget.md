...
用户在获知旧夜间主账本未同步后明确回复“直接用kimi”，授权继续使用本机现有接口与城市验证账本。本轮没有初始化、清空、替换账本或增加100元授权。后续不要再以同一份旧账本缺失为由重复索要授权；仍需验证现有城市账本及其 guard。

本轮8次原生居民请求及1次车夫实景复核均已结算，新增0.1821785元。本机城市账本现有31次结算，共0.4524905元，无新增未决。旧主账本的6笔未决并未因此消失：按远程已提交摘要保守保留17.3692551元旧负债，再加本机负债，合计17.8217456元。这个数是跨机摘要估算，**不是重建的主账本余额，也不是平台余额**。本轮每次付费前还将新请求最大预留计入95元上限检查。详见 [马车恢复验收](Validation/Freight_Recovery_2026-09-08.md)。
