...
namespace
{
    ...
    bool Add(FHearthStructurePlan& P,int32 N,float RoadYaw,const FString& Ext)
    {
        ...
        if(!Put(TEXT("floor_timber_2m"),K+TEXT("_floor"),FVector(X,0,Floor),0,TEXT("floor"),TEXT("plank"),true,K+TEXT("_foundation"))) return Fail();
        if(!Put(TEXT("post_timber_2_4m"),K+TEXT("_post_bl"),FVector(X-91.f,-91.f,Frame),0,TEXT("post"),TEXT("beam"),true,K+TEXT("_floor"))) return Fail();
        if(!Put(TEXT("post_timber_2_4m"),K+TEXT("_post_br"),FVector(X+91.f,-91.f,Frame),0,TEXT("post"),TEXT("beam"),true,K+TEXT("_floor"))) return Fail();
        if(!Put(TEXT("post_timber_2_4m"),K+TEXT("_post_fl"),FVector(X-91.f,91.f,Frame),0,TEXT("post"),TEXT("beam"),true,K+TEXT("_floor"))) return Fail();
        if(!Put(TEXT("post_timber_2_4m"),K+TEXT("_post_fr"),FVector(X+91.f,91.f,Frame),0,TEXT("post"),TEXT("beam"),true,K+TEXT("_floor"))) return Fail();
        if(!Put(TEXT("beam_timber_2m"),K+TEXT("_beam_back"),FVector(X,91.f,Top),0,TEXT("beam"),TEXT("beam"),true,K+TEXT("_post_fl"))) return Fail();
        if(!Put(TEXT("beam_timber_2m"),K+TEXT("_beam_front"),FVector(X,-91.f,Top),0,TEXT("beam"),TEXT("beam"),true,K+TEXT("_post_bl"))) return Fail();
        if(!Put(TEXT("beam_timber_2m"),K+TEXT("_beam_left"),FVector(X-91.f,0,Top),90,TEXT("beam"),TEXT("beam"),true,K+TEXT("_post_bl"))) return Fail();
        if(!Put(TEXT("beam_timber_2m"),K+TEXT("_beam_right"),FVector(X+91.f,0,Top),90,TEXT("beam"),TEXT("beam"),true,K+TEXT("_post_br"))) return Fail();
        if(!Put(TEXT("wall_timber_2m"),K+TEXT("_back"),FVector(X,100,0),0,TEXT("wall"),TEXT("plank"),true,K+TEXT("_floor"))) return Fail();
        if(!Put(TEXT("wall_timber_2m"),K+TEXT("_side_left"),FVector(X-100,0,0),90,TEXT("wall"),TEXT("plank"),true,K+TEXT("_floor"))) return Fail();
        ...
        if(!Put(TEXT("roof_slope_timber_2m"),K+TEXT("_roof_left"),FVector(X,0,Top+13.f),0,TEXT("roof"),TEXT("plank"),true,K+TEXT("_beam_right"))) return Fail();
        if(!Put(TEXT("roof_slope_timber_2m"),K+TEXT("_roof_right"),FVector(X,0,Top+13.f),180,TEXT("roof"),TEXT("plank"),true,K+TEXT("_beam_left"))) return Fail();
        ...
        if(!Link(TEXT("_floor_support"),K+TEXT("_floor"),K+TEXT("_foundation")) || !Link(TEXT("_post_bl_support"),K+TEXT("_post_bl"),K+TEXT("_floor")) || !Link(TEXT("_post_br_support"),K+TEXT("_post_br"),K+TEXT("_floor")) || !Link(TEXT("_post_fl_support"),K+TEXT("_post_fl"),K+TEXT("_floor")) || !Link(TEXT("_post_fr_support"),K+TEXT("_post_fr"),K+TEXT("_floor")) || !Link(TEXT("_beam_back_support"),K+TEXT("_beam_back"),K+TEXT("_post_fl")) || !Link(TEXT("_beam_back_post_fr"),K+TEXT("_beam_back"),K+TEXT("_post_fr")) || !Link(TEXT("_beam_front_support"),K+TEXT("_beam_front"),K+TEXT("_post_bl")) || !Link(TEXT("_beam_front_post_br"),K+TEXT("_beam_front"),K+TEXT("_post_br")) || !Link(TEXT("_beam_left_support"),K+TEXT("_beam_left"),K+TEXT("_post_bl")) || !Link(TEXT("_beam_left_post_fl"),K+TEXT("_beam_left"),K+TEXT("_post_fl")) || !Link(TEXT("_beam_right_support"),K+TEXT("_beam_right"),K+TEXT("_post_br")) || !Link(TEXT("_beam_right_post_fr"),K+TEXT("_beam_right"),K+TEXT("_post_fr")) || !Link(TEXT("_beam_back_left"),K+TEXT("_beam_back"),K+TEXT("_beam_left")) || !Link(TEXT("_beam_back_right"),K+TEXT("_beam_back"),K+TEXT("_beam_right")) || !Link(TEXT("_beam_front_left"),K+TEXT("_beam_front"),K+TEXT("_beam_left")) || !Link(TEXT("_beam_front_right"),K+TEXT("_beam_front"),K+TEXT("_beam_right")) || !Link(TEXT("_back_support"),K+TEXT("_back"),K+TEXT("_floor")) || !Link(TEXT("_left_support"),K+TEXT("_side_left"),K+TEXT("_floor")) || !Link(TEXT("_right_support"),K+TEXT("_side_right"),K+TEXT("_floor")) || !Link(TEXT("_door_support"),K+TEXT("_door"),K+TEXT("_floor")) || !Link(TEXT("_back_post_fl"),K+TEXT("_back"),K+TEXT("_post_fl")) || !Link(TEXT("_back_post_fr"),K+TEXT("_back"),K+TEXT("_post_fr")) || !Link(TEXT("_left_post_bl"),K+TEXT("_side_left"),K+TEXT("_post_bl")) || !Link(TEXT("_left_post_fl"),K+TEXT("_side_left"),K+TEXT("_post_fl")) || !Link(TEXT("_right_post_br"),K+TEXT("_side_right"),K+TEXT("_post_br")) || !Link(TEXT("_right_post_fr"),K+TEXT("_side_right"),K+TEXT("_post_fr")) || !Link(TEXT("_door_post_bl"),K+TEXT("_door"),K+TEXT("_post_bl")) || !Link(TEXT("_door_post_br"),K+TEXT("_door"),K+TEXT("_post_br")) || !Link(TEXT("_roof_left_support"),K+TEXT("_roof_left"),K+TEXT("_beam_right")) || !Link(TEXT("_roof_left_back"),K+TEXT("_roof_left"),K+TEXT("_beam_back")) || !Link(TEXT("_roof_left_front"),K+TEXT("_roof_left"),K+TEXT("_beam_front")) || !Link(TEXT("_roof_left_post_br"),K+TEXT("_roof_left"),K+TEXT("_post_br")) || !Link(TEXT("_roof_left_post_fr"),K+TEXT("_roof_left"),K+TEXT("_post_fr")) || !Link(TEXT("_roof_right_support"),K+TEXT("_roof_right"),K+TEXT("_beam_left")) || !Link(TEXT("_roof_right_back"),K+TEXT("_roof_right"),K+TEXT("_beam_back")) || !Link(TEXT("_roof_right_front"),K+TEXT("_roof_right"),K+TEXT("_beam_front")) || !Link(TEXT("_roof_right_post_bl"),K+TEXT("_roof_right"),K+TEXT("_post_bl")) || !Link(TEXT("_roof_right_post_fl"),K+TEXT("_roof_right"),K+TEXT("_post_fl")) || !Link(TEXT("_roof_pair"),K+TEXT("_roof_left"),K+TEXT("_roof_right"))) return Fail();
        return true;
    }
