...
namespace
{
    ...
    bool Add(FHearthStructurePlan& P,int32 N,float RoadYaw,const FString& Ext)
    {
        ...
        if(!Put(TEXT("roof_slope_timber_2m"),K+TEXT("_roof_left"),FVector(X,0,Top),0,TEXT("roof"),TEXT("plank"),true,K+TEXT("_beam_right"))) return Fail();
        if(!Put(TEXT("roof_slope_timber_2m"),K+TEXT("_roof_right"),FVector(X,0,Top),180,TEXT("roof"),TEXT("plank"),true,K+TEXT("_beam_left"))) return Fail();
