"""Validate imported ToolKit meshes without loading or changing the village world."""
import hashlib
import json
...
def main():
    ...
    report = {'status': 'passed', 'engine': ue.SystemLibrary.get_engine_version(),
              ...
              'inventory_binding_verified': False, 'socket_binding_verified': False,
              'work_animation_verified': False, 'assets': rows}
